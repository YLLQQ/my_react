...
# dependencies是指在使用npm i -save [modules] 的时候安装的，
# 执行 npm install --production 的时候会安装
"dependencies": {
    "react": "^16.8.6",
    "react-dom": "^16.8.6",
    "react-router-dom": "^5.0.1"
},
# devDependencies是指在使用npm i -save-dev [modules] 的时候安装的，
# 执行 npm install --production 的时候不会安装
"devDependencies": {
    // 安装babel相关的
    "@babel/core": "^7.4.5",
